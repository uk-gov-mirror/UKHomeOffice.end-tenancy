...
const Behaviour = require('../../../../apps/end-tenancy/behaviours/upload-pdf');
const PDFModel = require('../../../../apps/end-tenancy/models/pdf');
const UploadModel = require('../../../../apps/end-tenancy/models/upload');

describe('behaviours/upload-pdf', () => {
